...
class ColourWheelss extends Component {
  constructor () {
    super()
  ...
  componentDidMount () {
    ...
    this.canvasEl = document.getElementById('colour-picker2')
